...
public class ResolverUtil<T>
{
	 ...
	 */
	private static final Logger LOG = Logger.getLogger( ResolverUtil.class.getName() );
	...
	public void findInPackage( Test test, String packageName )
	{
		...
		{
			LOG.log( Level.WARNING, "Could not read package: " + packageName, ioe );
			return;
		}
	...
	private void loadImplementationsInJar( Test test, String parent, File jarfile )
	{
		...
		{
			LOG.log( Level.SEVERE, "Could not search jar file '" + jarfile + "' for classes matching criteria: " +
	...
	protected void addIfMatching( Test test, String fqn )
	{
		try
		{
			...
			if( test.doesMatchClass() )
			{
				...
				{
					LOG.finest( "Checking to see if class " + externalName + " matches criteria [" + test + "]" );
				}
		...
		{
			LOG.log( Level.WARNING, "Could not examine class '" + fqn + "' due to a " +
